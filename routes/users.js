...
router.get('/', async function(req, res, next) {
    ...
    if (req.user.user_role === 3){
      ...
      res.render('admin-Mprofil', {
        title: 'Admins',
        usersurname: admin.administrator_surname,
        username: admin.administrator_name,
        email: admin.administrator_email,
        phone: admin.administrator_telephone
      });
    }
});
