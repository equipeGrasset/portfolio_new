...
const selectProfessorSql = "SELECT p.professor_name, p.professor_surname ,p.professor_email, p.professor_telephone, u.user_id FROM professors p INNER JOIN users u ON p.employee_number = u.user_id WHERE user_id = ?";
...
module.exports = { connect,MProfilAdmin,StudentID,createAdmin,createProfessorAccount, findListeproject, findproject , MProfilETud, MprofilEnsg, findStudentProfil, createAccount, findAdmin, findProfessor, findStudent, validerCredentials }
